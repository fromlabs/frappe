...
// Keypad as a functional logic unit.
//
// Demonstrates: snapshot, whereType, mapToUnit, orElse, where,
// ValueStateLink, DisposableCollector.
...
class Keypad {
  ...
  Keypad({required EventStream<NumericKey> keypadStream}) {
